...
# if district.region.code=="CZ010"
  pdf.text "Seznam delegovaných členů do okrskové(-ých) volební(-ch) komise(-í) pro volby do Senátu Parlamentu České republiky, které  se uskuteční ve dnech 12. a 13. října 2012.", :style => :bold
#   pdf.move_down 20
pdf.text "V souladu s ustanovením § 14e odst. 3 a 4 zákona č. 247/1995 Sb. o volbách do Parlamentu České republiky a o změně a doplnění některých dalších zákonů, ve znění pozdějších předpisů tímto politická strana Strana svobodných občanů, jejíž kandidátní listina byla zaregistrována pro volby, deleguje níže uvedené členy do okrskové(-ých) volební(ích) komise(-í) vaší obce - města."
